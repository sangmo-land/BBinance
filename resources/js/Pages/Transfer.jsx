...
export default function Transfer({ userAccounts, allAccounts, currencies }) {
    ...
    const structuredData = {
        ...
        name: "Civicon Exchange Money Transfer",
        description:
            "Instant multi-currency money transfers with real-time exchange rates",
        provider: {
            "@type": "FinancialService",
    ...
    return (
        <AppLayout>
            <SEOHead
                title="Transfer Money Instantly | Multi-Currency Support | Civicon Exchange"
                description="Transfer money between accounts instantly with Civicon Exchange. Multi-currency support, real-time exchange rates, and bank-grade security. No hidden fees."
            ...
            <div className="px-4 sm:px-0">
                ...
                <div className="mb-12">
                    ...
                    <p className="text-lg text-gray-600 max-w-2xl">
                        Transfer funds between accounts with bank-grade
                        security. Multi-currency support with real-time exchange
                        rates.
                    </p>
                </div>
                                ...
                                <div>
                                    ...
                                    {fromAccounts.length === 0 && (
                                        <p className="mt-2 text-sm text-amber-600 flex items-center gap-2">
                                            <span>ℹ️</span> No active accounts.
                                            Create one first.
                                        </p>
                                    )}
                                </div>
                                    ...
                                    {selectedToAccount && (
                                        <div className="mt-4 p-4 bg-gradient-to-r from-emerald-50 to-green-50 rounded-xl border border-emerald-100">
                                            ...
                                            <p className="text-xl font-semibold text-gray-900">
                                                {selectedToAccount.user.name}
                                            </p>
                                            <p className="text-sm text-gray-600 mt-2">
                                                Account •{" "}
                                                {
                                                    selectedToAccount.account_number
                                                }{" "}
