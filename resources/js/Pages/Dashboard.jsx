...
export default function Dashboard({ accounts, groupedUsers, transactions, isAdmin, stats }) {
  ...
  return (
      <AppLayout>
          <SEOHead
              title={
                  isAdmin ? "Admin Dashboard | AppDemo" : "Dashboard | AppDemo"
              }
              description="View your accounts, balances, and recent transfers in AppDemo."
                  ...
                  <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-6">
                      <div>
                          ...
                          <p className="text-lg text-gray-700 max-w-2xl">
                              Manage your finances with confidence. Track
                              balances, monitor transactions, and transfer funds
                              seamlessly.
                          </p>
                      </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
                          ...
                          <div className="flex gap-6 text-sm opacity-90">
                              <div>
                                  ...
                                  <p className="font-bold">
                                      €{formatNumber(totalEur, 2)}
                                  </p>
                              </div>
                              <div>
                                  <p className="text-xs mb-1 opacity-75">BTC</p>
                                  <p className="font-bold">
                                      {formatNumber(totalBtc, 8)}
                                  </p>
                              </div>
                          </div>
                      </div>
                  ...
                  <div className="bg-white rounded-2xl shadow-lg border border-gray-100 p-6 hover:shadow-xl transition-shadow">
                      ...
                      <p className="text-4xl font-black text-gray-900 mb-2">
                          {stats?.accountCount ?? accountsList.length}
                      </p>
                  ...
                  <div className="flex items-center justify-between mb-6">
                      <div>
                          ...
                          <p className="text-sm text-gray-600 mt-1">
                              Manage and monitor your banking accounts
                          </p>
                      </div>
                      {paginationLinks && (
                          <p className="text-sm text-gray-500">
                  ...
                  {isAdmin && groupedUsers ? (
                      <div className="space-y-12">
                          {groupedUsers.data.map((user) => (
                              <div
                                  key={user.id}
                                  className="bg-white border border-gray-100 rounded-3xl overflow-hidden shadow-xl hover:shadow-2xl transition-shadow duration-300"
                              >
                                  {/* User Header with Gradient */}
                                  <div className="bg-gradient-to-r from-slate-900 to-slate-800 p-6 sm:p-8">
                                      <div className="flex items-center gap-5">
                                          <div className="relative">
                                              <div className="w-16 h-16 rounded-2xl bg-gradient-to-br from-blue-500 to-indigo-600 text-white flex items-center justify-center font-black text-2xl shadow-lg ring-4 ring-white/10">
                                                  {user.name
                                                      .charAt(0)
                                                      .toUpperCase()}
                                              </div>
                                              <div className="absolute -bottom-1 -right-1 w-5 h-5 bg-emerald-500 rounded-full border-4 border-slate-800"></div>
                                          </div>
                                          <div>
                                                  ...
                                                  <div className="flex items-start justify-between mb-6">
                                                      <div className="flex-1">
                                                          <div className="flex items-center gap-2 mb-3">
                                                              ...
                                                              <span
                                                                  className={`w-2 h-2 rounded-full ${account.is_active ? "bg-emerald-500 shadow-[0_0_8px_rgba(16,185,129,0.4)]" : "bg-gray-300"}`}
                                                              ></span>
                                                          </div>
                                                          <p className="text-lg font-mono font-bold text-gray-900 tracking-tight">
                                                              {
                                  ...
                                  <div className="flex items-start justify-between mb-4">
                                      <div className="flex-1">
                                          <div className="flex items-center gap-2 mb-2">
                                              ...
                                              <span
                                                  className={`text-xs font-bold px-3 py-1 rounded-full ${account.is_active ? "bg-emerald-100 text-emerald-700" : "bg-gray-100 text-gray-700"}`}
                                              >
                                                  {account.is_active
                                                      ? "Active"
                                                      : "Inactive"}
                                          ...
                                          <div className="mb-2 mt-1">
                                              <span
                                                  className={`text-sm font-black uppercase tracking-wide px-3 py-1 rounded-lg ${
                                                      account.account_type ===
                                                      "fiat"
                          ...
                          <table className="min-w-full">
                              <thead className="bg-gradient-to-r from-gray-50 to-gray-100 border-b border-gray-200">
                                  <tr className="text-left">
                                      <th className="p-5 text-xs font-bold text-gray-600 uppercase tracking-wider">
                                          Reference
                                      </th>
                                      <th className="p-5 text-xs font-bold text-gray-600 uppercase tracking-wider">
                                          From
                              ...
                              <tbody className="divide-y divide-gray-100">
                                  {(transactions ?? []).length === 0 ? (
                                      ...
                                      (transactions ?? []).map((tx) => {
                                          const fromAcc =
                                              tx.from_account || tx.fromAccount;
                                          const toAcc =
                                              tx.to_account || tx.toAccount;

                                          // Calculate From Label
                                          let fromLabel =
                                              fromAcc?.account_number;
                                          if (!fromLabel) {
                                              if (tx.type === "admin_credit")
                                                  fromLabel = "Admin"; // Admin Credit
                                              else if (tx.type === "deposit")
                                                  fromLabel =
                                                      "External Deposit";
                                              else if (tx.from_account_id)
                                                  fromLabel = `#${tx.from_account_id}`;
                                              else fromLabel = "—";
                                          }
                                          ...
                                          return (
                                              ...
                                              >
                                                  ...
                                                  <td className="p-5">
                                                      <span
                                                          className={`inline-flex items-center gap-1.5 text-xs font-bold px-3 py-1.5 rounded-full ${tx.status === "completed" ? "bg-emerald-100 text-emerald-700" : tx.status === "failed" ? "bg-red-100 text-red-700" : "bg-amber-100 text-amber-700"}`}
                                                      >
                                                          {tx.status ===
                                                              "completed" && (
                                                              <svg
