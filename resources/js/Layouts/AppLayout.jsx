        ...
        <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100">
            ...
            <nav className="sticky top-0 z-50 bg-white/95 backdrop-blur-md shadow-sm border-b border-gray-200/50">
                        ...
                        <div className="flex items-center space-x-8">
                            <Link href="/" className="flex items-center group">
                                <div className="relative flex-shrink-0 flex items-center">
                                    ...
                                    {/* Logo */}
                                    <div className="relative bg-gradient-to-br from-blue-600 to-indigo-700 p-2 rounded-lg shadow-md transform group-hover:scale-105 transition-transform duration-200">
                                        <svg className="h-6 w-6 text-white" fill="currentColor" viewBox="0 0 24 24">
                                            <path d="M12 2L2 7v10c0 5.55 3.84 10.74 9 12 5.16-1.26 9-6.45 9-12V7l-10-5z"/>
                                        </svg>
                                    </div>
                                    
                                    <span className="ml-3 text-2xl font-bold bg-gradient-to-r from-blue-700 to-indigo-700 bg-clip-text text-transparent">
                                        HSBC
                                    </span>
                                </div>
                            </Link>
                ...
                {mobileMenuOpen && auth?.user && (
                    <div ref={mobileMenuRef} className="md:hidden border-t border-gray-200 bg-white animate-fadeIn">
                        <div className="px-4 pt-2 pb-3 space-y-1">
                            <Link
                                href={isActive('/dashboard') && auth?.user?.is_admin ? '/admin/dashboard' : '/dashboard'}
                                className={`
                        ...
                        <div className="pt-4 pb-3 border-t border-gray-200">
                            <div className="px-4 flex items-center space-x-3">
                                ...
                                <div>
                                    <div className="text-base font-semibold text-gray-900">{auth.user.name}</div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
                        ...
                        <div className="md:col-span-1">
                            <div className="flex items-center mb-4">
                                ...
                                <span className="ml-3 text-xl font-bold text-white">HSBC</span>
                            </div>
                            <p className="text-sm text-gray-400 leading-relaxed">
                                Secure, reliable digital banking for the modern world.
                            </p>
                        </div>
                        ...
                        <div>
                            ...
                            <ul className="space-y-2">
                                ...
                                <li>
                                    <Link href="/transfer" className="text-sm hover:text-blue-400 transition-colors">
                                        Transfer
                                    </Link>
                                </li>
                            </ul>
